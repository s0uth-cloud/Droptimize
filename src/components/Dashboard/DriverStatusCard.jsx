...
/**
 * Displays the driver status breakdown (Available, On Trip, Offline) using a pie chart.
 * If no data is available, it shows a fallback message instead of an empty chart.
 */
