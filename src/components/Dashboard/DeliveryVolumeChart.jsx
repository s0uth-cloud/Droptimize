...
/**
 * Displays a line chart showing total deliveries, success rate, and failed/returned parcels
 * with toggle options for daily and weekly data.
 */
export default function DeliveryVolumeChart({ dailyData = [], weeklyData = [] }) {
  const [view, setView] = useState("daily");

  // Handles switching between daily and weekly views
  const handleChange = (_, nextView) => {
    if (nextView) setView(nextView);
  };

  // Select which dataset to show based on current view
